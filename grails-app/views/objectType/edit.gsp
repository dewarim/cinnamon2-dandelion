                        ...
                        <tbody>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean:objectType,field:'name','errors')}">
                                    <input type="text" name="name" id="name" value="${fieldValue(bean:objectType,field:'name')}" />
                                </td>
                            </tr> 
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean:objectType,field:'description','errors')}">
                                    ...
                                    <g:descriptionTextArea name="description" value="${fieldValue(bean:objectType,field:'description')}" />
                                </td>
                            </tr> 
