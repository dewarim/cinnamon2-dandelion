...
<div class="ajax_form" style="padding-top: 2ex;padding-bottom: 2ex;">
	...
	<g:select id="exportLanguage" from="${languages}" name="language" optionKey="id" optionValue="${{ server.i18n.LocalMessage.loc(it.isoCode) }}"/>
...
<div class="ajax_form" style="padding-top: 2ex;padding-bottom: 2ex;">
	...
	<g:select id="targetLanguage" from="${languages}" name="targetLanguage" optionKey="id" optionValue="${{ server.i18n.LocalMessage.loc(it.isoCode) }}"/>
