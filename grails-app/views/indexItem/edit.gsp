	...
	<div class="nav">
        ...
        <div class="body">
            ...
            <g:form method="post" >
                ...
                <g:hiddenField name="obj_version" value="${indexItemInstance?.obj_version}" />
                <div class="dialog">
                    <table>
                        <tbody>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: indexItemInstance, field: 'indexGroup', 'errors')}">
                                    <g:select id="indexGroup" name="indexGroup.id" from="${server.index.IndexGroup.list()}" optionKey="id" value="${indexItemInstance?.indexGroup?.id}" optionValue="name" />
                                </td>
                            </tr>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: indexItemInstance, field: 'indexType', 'errors')}">
                                    <g:select id="indexType" name="indexType.id" from="${server.index.IndexType.list()}" optionKey="id" value="${indexItemInstance?.indexType?.id}" optionValue="name" />
                                </td>
                            </tr>
