                        ...
                        <tbody>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean:format,field:'contenttype','errors')}">
                                    <input type="text" name="contenttype" id="contenttype" value="${fieldValue(bean:format,field:'contenttype')}" />
                                </td>
                            </tr> 
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean:format,field:'description','errors')}">
                                    ...
                                    <g:descriptionTextArea name="description" value="${fieldValue(bean:format,field:'description')}" />
                                </td>
                            </tr> 
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean:format,field:'extension','errors')}">
                                    <input type="text" name="extension" id="extension" value="${fieldValue(bean:format,field:'extension')}" />
                                </td>
                            </tr> 
