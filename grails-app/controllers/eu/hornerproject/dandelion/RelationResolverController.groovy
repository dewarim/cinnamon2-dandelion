...
//        if(params.className){
//            relationResolver = new RelationResolver(params)
//        }
//        else{
...
//        }
    ...
    protected void updateFields(relationResolver) {
        ...
        try {
            ...
            IRelationResolver testResolver = (IRelationResolver) Class.forName(params.resolverClass, true, Thread.currentThread().contextClassLoader ).newInstance()
            relationResolver.resolverClass = (Class<? extends IRelationResolver>) Class.forName(params.resolverClass, true, Thread.currentThread().contextClassLoader )
        }
