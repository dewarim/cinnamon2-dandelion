...
class TransformerController extends BaseController{
    ...
    protected void updateFields(transformer) {
        ...
        try {
            ...
            ITransformer transformerClass = (ITransformer) Class.forName(params.transformerClass, true, Thread.currentThread().contextClassLoader ).newInstance()
            transformer.transformerClass = (Class<? extends ITransformer>) Class.forName(params.transformerClass, true, Thread.currentThread().contextClassLoader )
        }
